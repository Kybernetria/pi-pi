...
- added a reusable protocol routing policy so simple requests stay direct while build/modify/integrate/reuse requests check protocol first and fall back cleanly when no installed capability fits
