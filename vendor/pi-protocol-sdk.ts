// Vendored from the pi-protocol prototype SDK so pi-pi remains standalone-installable.
// Keep behavior aligned with the shared fabric model and update from the upstream prototype as needed.
